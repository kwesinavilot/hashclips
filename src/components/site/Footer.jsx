...
export default function Footer() {
    return (
        <footer className="flex h-14 bottom-0 border-t bg-background px-4 justify-between">
            <div className="mr-4 hidden md:flex ">
                <p class="text-balance text-center text-sm leading-loose text-muted-foreground md:text-left">
                    Built by <a href="https://x.com/nolansym" target="_blank" rel="noreferrer" class="font-medium underline underline-offset-4">Andrews Kwesi Ankomahene</a>.
                    The source code is available on <a href="https://github.com/kwesinavilot/hashclips" target="_blank" rel="noreferrer" class="font-medium underline underline-offset-4">GitHub</a>.
                </p>
            </div>
